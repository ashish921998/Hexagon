    ...
    return (
      <div className={styles.subPart_container}>
        <div className={styles.subPar_logo}>
          <img
            src="https://st1.dineout-cdn.co.in/images/uploads/misc/2019/Jun/19/group_30.png"
            alt="cuisine"
          />
        </div>
  ...
  if (props.type === "tag") {
    return (
      <div className={styles.subPart_container}>
        <div className={styles.subPar_logo}>
          <img
            src="https://st1.dineout-cdn.co.in/images/uploads/misc/2019/Jun/19/group_5.png"
            alt="type"
          />
        </div>
        <div className={styles.subpart_info}>
